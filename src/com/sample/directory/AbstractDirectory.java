  ...
  implements Directory
{
  ...
  protected abstract InputStream getFileInputLocal(String paramString) throws DirectoryException;

  protected abstract OutputStream getFileOutputLocal(String paramString) throws DirectoryException;

  protected abstract AbstractDirectory createDirLocal(String paramString) throws DirectoryException;
