...
public class ExtDataOutput extends DataOutputDelegate
{
  ...
  public void writeCheckInt(int value, int expected) throws IOException {
    ...
    if (value != expected)
      throw new IOException(String.format(
        "Expected: 0x%08x, got: 0x%08x", new Object[] { Integer.valueOf(expected), Integer.valueOf(value) }));
  }
  ...
  public void writeCheckShort(short value, short expected) throws IOException
  {
    ...
    if (value != expected)
      throw new IOException(String.format(
        "Expected: 0x%08x, got: 0x%08x", new Object[] { Short.valueOf(expected), Short.valueOf(value) }));
  }
  ...
  public void writeCheckByte(byte value, byte expected) throws IOException
  {
    ...
    if (value != expected)
      throw new IOException(String.format(
        "Expected: 0x%08x, got: 0x%08x", new Object[] { Byte.valueOf(expected), Byte.valueOf(value) }));
  }
}